...
<div className='text-white flex flex-col mb-9 gap-5'>
...
<div className='text-white flex mt-4 borderBottom pb-3 items-center'>
  <input type='email' placeholder='Tour email' className='bg-transparent w-80'/>
